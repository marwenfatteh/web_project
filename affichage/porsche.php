...
$res=mysqli_query($idcon,"select * from voiture where(marque='porsche');") or die(mysqli_error($idcon));
...
<html lang="fr">
    <head>
        <meta charset="UTF-8">
        <title>Audi</title>
        <link rel="stylesheet" href="../css/stylevoiture.css">
...
?>
           <div class="voituree">
            <table id="table_carac">
                <tr>
                 <td><?php echo "<img height='250px' width='100%' src='voiture/porsche/".$t['image_v']."' />"; ?></td>
                 <th>Marque &nbsp:</th>
