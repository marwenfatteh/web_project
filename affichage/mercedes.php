...
$res=mysqli_query($idcon,"select * from voiture where(marque='mercedes');") or die(mysqli_error($idcon));
...
?>
           <div class="voituree">
            <table id="table_carac">
                <tr>
                 <td><?php echo "<img height='250px' width='100%' src='voiture/mercedes/".$t['image_v']."' />"; ?></td>
                 <th>Marque &nbsp:</th>
