...
$res=mysqli_query($idcon,"select * from voiture where(marque='chevrolet');") or die(mysqli_error($idcon));
...
?>
            ...
            <table id="table_carac">
                <tr>
                 <td><?php echo "<img height='250px' width='100%' src='voiture/chevrolet/".$t['image_v']."' />"; ?></td>
                 <th>Marque &nbsp:</th>
            ...
            <footer>
                ...
                <div id="copyrightEtIcons">
                  <div id="copyright">
                  <h1> Copyright <span>©2021</span>By <span>Mahdi&Malek</span>. All Rights Reserved</h1>
                  </div>
                  <div id="icons">
