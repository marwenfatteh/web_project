...
$res=mysqli_query($idcon,"select * from voiture where(marque='Audi');") or die(mysqli_error($idcon));
...
?>
            ...
            <table id="table_carac">
                <tr>
                 <td><?php echo "<img height='250px' width='100%' src='voiture/audi/".$t['image_v']."' />"; ?></td>
                 <th>Marque &nbsp:</th>
